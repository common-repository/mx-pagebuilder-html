...
class MXMPH_Model
{
	...
	* Table name
	*/
	protected $table = MXMPH_TABLE_SLUG;
	...
	*/
	public function mxmph_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxmph_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
